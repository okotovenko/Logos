    ...
    (() => {
        ...
        function formQuantity() {
            document.addEventListener("click", (function(e) {
                let targetElement = e.target;
                if (targetElement.closest("[data-quantity]")) {
                    let valueCart = this.querySelector("[data-quantity-cart]");
                    let cart = parseInt(valueCart.value);
                    const cartItem = targetElement.closest("[data-quantity]").querySelector(".swiper-slide-eats__cart");
                    const bottom = targetElement.closest("[data-quantity]").querySelector(".swiper-slide-eats__bottom");
                    if (targetElement.closest("[data-quantity-plus]") || targetElement.closest("[data-quantity-minus]")) {
                        const valueElement = targetElement.closest("[data-quantity]").querySelector("[data-quantity-value]");
                        const valuePrice = targetElement.closest("[data-quantity]").querySelector("[data-quantity-price]");
                        let swiperSlidePriceSpan = targetElement.closest("[data-quantity]").querySelector(".swiper-slide-eats__price-span").innerHTML;
                        let value = parseInt(valueElement.value);
                        let price = parseInt(valuePrice.value);
                        if (targetElement.hasAttribute("data-quantity-plus")) {
                            price = swiperSlidePriceSpan;
                            value++;
                            price *= value;
                            cart++;
                        ...
                        targetElement.closest("[data-quantity]").querySelector("[data-quantity-price]").value = price;
                        valueCart.value = cart;
                    }
                    if (targetElement.closest(".swiper-slide-eats__buy")) {
                        cartItem.classList.add("active");
                        bottom.classList.add("active");
                    }
                }
                if (targetElement.closest("[data-basket-quantity-plus]") || targetElement.closest("[data-basket-quantity-minus]")) {
                    const valueElement = targetElement.closest("[data-basket-quantity]").querySelector("[data-basket-quantity-value]");
                    let value = parseInt(valueElement.value);
                    if (targetElement.hasAttribute("data-basket-quantity-plus")) {
                        value++;
                        if (+valueElement.dataset.quantityMax && +valueElement.dataset.quantityMax < value) value = valueElement.dataset.quantityMax;
                    } else {
                        --value;
                    ...
                    targetElement.closest("[data-basket-quantity]").querySelector("[data-basket-quantity-value]").value = value;
                }
                if (targetElement.closest("[data-quantity-form-plus]") || targetElement.closest("[data-quantity-form-minus]")) {
                    const valueElement = targetElement.closest("[data-quantity-form]").querySelector("[data-quantity-form-value]");
                    let value = parseInt(valueElement.value);
                    if (targetElement.hasAttribute("data-quantity-form-plus")) {
                        value++;
                        if (+valueElement.dataset.quantityMax && +valueElement.dataset.quantityMax < value) value = valueElement.dataset.quantityMax;
                    } else {
                        --value;
                    ...
                    targetElement.closest("[data-quantity-form]").querySelector("[data-quantity-form-value]").value = value;
                }
                if (targetElement.closest("[data-required]")) {
                    document.querySelectorAll("[data-required]");
                    document.addEventListener("input", (function(input) {
                        input.target.labels[0].innerText;
                        if (input.data) input.target.labels[0].innerText = "";
                    }));
                }
            }));
        }
        ...
        const picker = new index_es("[data-datepicker]", {
            selectedDates: [ new Date ],
            isMobile: true,
            autoClose: true,
            timepicker: true
        });
        modules_flsModules.AirDatepicker = picker;
        ...
        function initSliders() {
            if (document.querySelector(".eats__swiper")) new core(".eats__swiper", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
        ...
        var goTopBtn = document.querySelector("._icon-Arrow");
